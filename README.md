...
* "films_genres" - provides the many-to-many relationship between "films" and "genres".
* "users" - storing information about users.
* "friends" - storing information about existing friendships between users. Has a many-to-many relationship with "users".
* "films_likes" - storing information about likes. Has a many-to-many relationship with "films" and "users".
...
* "mpa" – хранение рейтингов MPA. Поддерживает связь «one-to-many» с таблицей "films". Данные таблицы доступны только для чтения.
* "genres" – хранение представленных жанров. Данные таблицы доступны только для чтения.
* "films_genres" – реализует связь «many-to-many» между таблицами "films" и "genres".
* "users" – хранение информации о пользователях.
* "friends" – хранение информации о дружбе между пользователями. Связана отношением «many-to-many» с таблицей "users".
* "films_likes" – хранение лайков. Имеет связь «many-to-many» с таблицами "films" и "users".
